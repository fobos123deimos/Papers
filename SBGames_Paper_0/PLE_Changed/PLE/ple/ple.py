...
class PLE(object):
    ...
    def init(self):#Modificação
        ...
        """
        self.game._setup()
        self.game.init(self.game.Gap_Vector,self.game.MAX_CONT) #this is the games setup/init
    ...
    def reset_game(self,Gap_Vector=[],MAX_CONT=0):#Modificação
        """
        ...
        self.game.reset(Gap_Vector,MAX_CONT)
